% 3_D 3 ions Monte Carlo simulations
mp=1.67e-27;
m1=40*mp;
m2=2*mp;
k=1.38e-23;
...
for i=2:N
    ...
    a(1,1,2)=-k1/m1*r(i-1,1,2)+kq/m1*((r(i-1,1,2)-r(i-1,2,2))/(d12(i))^3+(r(i-1,1,2)-r(i-1,3,2))/(d31(i))^3);
    a(1,1,3)=-k2/m1*r(i-1,1,3)+kq/m1*((r(i-1,1,3)-r(i-1,2,3))/(d12(i))^3+(r(i-1,1,3)-r(i-1,3,3))/(d31(i))^3);
    a(1,2,1)=-k1/m1*r(i-1,2,1)+kq/m1*((r(i-1,2,1)-r(i-1,1,1))/(d12(i))^3+(r(i-1,2,1)-r(i-1,3,1))/(d23(i))^3);
    a(1,2,2)=-k1/m1*r(i-1,2,2)+kq/m1*((r(i-1,2,2)-r(i-1,1,2))/(d12(i))^3+(r(i-1,2,2)-r(i-1,3,2))/(d23(i))^3);
    a(1,2,3)=-k2/m1*r(i-1,2,3)+kq/m1*((r(i-1,2,3)-r(i-1,1,3))/(d12(i))^3+(r(i-1,2,3)-r(i-1,3,3))/(d23(i))^3);
    a(1,3,1)=-k1/m1*r(i-1,3,1)+kq/m1*((r(i-1,3,1)-r(i-1,2,1))/(d23(i))^3+(r(i-1,3,1)-r(i-1,1,1))/(d31(i))^3);
    a(1,3,2)=-k1/m1*r(i-1,3,2)+kq/m1*((r(i-1,3,2)-r(i-1,2,2))/(d23(i))^3+(r(i-1,3,2)-r(i-1,1,2))/(d31(i))^3);
    a(1,3,3)=-k2/m1*r(i-1,3,3)+kq/m1*((r(i-1,3,3)-r(i-1,2,3))/(d23(i))^3+(r(i-1,3,3)-r(i-1,1,3))/(d31(i))^3);
    v(i,:,:)=v(i-1,:,:)+tau*a;
